...
# Replacing colors
sed -i -e 's/shade1 = .*/shade1 = #2b2b2b/g' $PDIR/colors.ini
sed -i -e 's/shade2 = .*/shade2 = #424242/g' $PDIR/colors.ini
sed -i -e 's/shade3 = .*/shade3 = #000000/g' $PDIR/colors.ini
sed -i -e 's/shade4 = .*/shade4 = #2b2b2b/g' $PDIR/colors.ini
sed -i -e 's/shade5 = .*/shade5 = #2b2b2b/g' $PDIR/colors.ini
sed -i -e 's/shade6 = .*/shade6 = #2b2b2b/g' $PDIR/colors.ini
sed -i -e 's/shade7 = .*/shade7 = #2b2b2b/g' $PDIR/colors.ini
sed -i -e 's/shade8 = .*/shade8 = #c7c7c7/g' $PDIR/colors.ini
sed -i -e 's/accent = .*/accent = #2b2b2b/g' $PDIR/colors.ini
sed -i -e 's/bground = .*/bground = #000000/g' $PDIR/colors.ini
sed -i -e 's/modulefg-alt = .*/modulefg-alt = #4B5056/g' $PDIR/colors.ini
# Restarting polybar
$LAUNCH &
